 ...
 * </copyright>
 *
 * @version $Id: ErrorPropagationItemProvider.java,v 1.1 2006-08-18 13:26:30 phf Exp $
 */
...
/**
 * This is the item provider adapter for a {@link edu.cmu.sei.aadl.errorannex.ErrorPropagation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ErrorPropagation_in_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ErrorPropagation_in_feature", "_UI_ErrorPropagation_type"),
				 ErrorannexPackage.Literals.ERROR_PROPAGATION__IN,
				 true,
				 false,
				 false,
	...
	protected void addOutPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ErrorPropagation_out_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ErrorPropagation_out_feature", "_UI_ErrorPropagation_type"),
				 ErrorannexPackage.Literals.ERROR_PROPAGATION__OUT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
