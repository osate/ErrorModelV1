 ...
 * </copyright>
 *
 * @version $Id: ErrorStateItemProvider.java,v 1.1 2006-08-18 13:26:30 phf Exp $
 */
...
/**
 * This is the item provider adapter for a {@link edu.cmu.sei.aadl.errorannex.ErrorState} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ErrorStateItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ErrorState_initial_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ErrorState_initial_feature", "_UI_ErrorState_type"),
				 ErrorannexPackage.Literals.ERROR_STATE__INITIAL,
				 true,
				 false,
				 false,
	...
	protected void addInactivePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ErrorState_inactive_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ErrorState_inactive_feature", "_UI_ErrorState_type"),
				 ErrorannexPackage.Literals.ERROR_STATE__INACTIVE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((ErrorState)object).getName();
