 ...
 * </copyright>
 *
 * @version $Id: ErrorModelTypeItemProvider.java,v 1.1 2006-08-18 13:26:30 phf Exp $
 */
...
/**
 * This is the item provider adapter for a {@link edu.cmu.sei.aadl.errorannex.ErrorModelType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ErrorModelTypeItemProvider
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ErrorannexPackage.Literals.ERROR_MODEL_TYPE__FEATURES);
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ErrorannexPackage.Literals.ERROR_MODEL_TYPE__FEATURES,
				 ErrorannexFactory.eINSTANCE.createErrorEvent()));

		newChildDescriptors.add
			(createChildParameter
				(ErrorannexPackage.Literals.ERROR_MODEL_TYPE__FEATURES,
				 ErrorannexFactory.eINSTANCE.createErrorState()));

		newChildDescriptors.add
			(createChildParameter
				(ErrorannexPackage.Literals.ERROR_MODEL_TYPE__FEATURES,
				 ErrorannexFactory.eINSTANCE.createErrorPropagation()));
	}
